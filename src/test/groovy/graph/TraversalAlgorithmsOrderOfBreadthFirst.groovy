...
class TraversalAlgorithmsOrderOfBreadthFirst extends Specification {
    ...
    def generateThreeVerticesTree() {
        ...
        return ['three vertices tree', graph, ['A', 'C', 'B']]
    }
    ...
    @Unroll
    def 'breadth-first-traversal connected vertices order: #name'() {
